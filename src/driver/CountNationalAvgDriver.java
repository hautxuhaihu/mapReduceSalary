...
import mapper.CountNationalAvgMapper;
...
public class CountNationalAvgDriver {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        Path input = new Path("/results/result1-5/part-r-00000");
        Path output = new Path("/results/result6");
        ...
        job.setJarByClass(CountNationalAvgDriver.class);
        job.setMapperClass(CountNationalAvgMapper.class);
